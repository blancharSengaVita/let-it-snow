...
export class Circle {
    ...
    constructor(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, mousePosition: { x: number; y: number }, radius: settings.snowflake.radius, color: string = , alpha: number = 0) {
        this.canvas = canvas;
        this.ctx = ctx;
        this.alpha = alpha;
